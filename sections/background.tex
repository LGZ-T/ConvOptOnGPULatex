...
\begin{figure}[t!]
\centering
\subfloat[Demonstration of depthwise convolution.]{\includegraphics[height=2.5cm]{./figure/depthwisedemo.eps}
	\label{fig:dwdemo}}
\vspace{1em}
\subfloat[Demonstration of pointwise convolution.]{\includegraphics[height=2.5cm]{./figure/pointwisedemo.eps}
	\label{fig:pwdemo}}
