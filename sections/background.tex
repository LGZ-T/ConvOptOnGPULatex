...
\begin{figure}[t!]
\centering
\subfloat[Depthwise convolution: three $5 \times 5$ 2D filters are used to convolve with one 3-channel $12 \times 12$ input and generate one 3-channel $8 \times 8$ output.]{\includegraphics[height=2.5cm]{./figure/depthwisedemo.eps}
	\label{fig:dwdemo}}
\vspace{1em}
\subfloat[Pointwise convolution: four 3-channel $1 \times 1$ filters are used to convolve with one 3-channel $8 \times 8$ input and generate one 4-channel $8 \times 8$ output.]{\includegraphics[height=2.5cm]{./figure/pointwisedemo.eps}
	\label{fig:pwdemo}}
