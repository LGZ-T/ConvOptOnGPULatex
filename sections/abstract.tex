...
we use shuffle instructions to exchange overlapped columns of input to reduce the number of memory transactions. When sliding a filter on the height
dimension, we multiply each overlapped row of input with multiple rows of a filter to calculate multiple output elements.
