...
computation overhead of a standard multi-channeled 2D convolution. Existing implementations of depthwise separable convolutions target
...
for small-batch-sized model training and the typical scenario of model inferencing where the model takes in a few samples at once.
%
