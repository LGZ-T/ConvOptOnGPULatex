...
%
We apply our approach to two representative convolutional operations, 2D and depth-wise convolution, on an NVIDIA 2080Ti GPU. For 2D
...
convolution, we obtain up to 4x speedups over the quickest algorithm of cuDNN.
