...
We show that, when using a moderate batch size, our approach averagely reduces the end-to-end training time of MobileNet and EfficientNet-B0 by 9.7\% and 7.3\% respectively, and reduces the end-to-end inference time of MobileNet and EfficentNet-B0 by 12.2\% and 13.5\% respectively.
\end{abstract}
