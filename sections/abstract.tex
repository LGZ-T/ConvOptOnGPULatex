...
$3\times$) performance improvement over cuDNN. We show that our approach improves the end-to-end training and inference performance of MobileNet and EfficientNet-B0
when using a moderate batch size by 10.6\% and 10.7\% on average, respectively.
