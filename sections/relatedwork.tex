...
Unlike our approach, none of these methods explicitly considers SM utilization, which is vital for achieving good performance for DSC on
GPUs. \RV{The work presented in \cite{chen2019versatile} also target column and row reuse. However, their approach requires more warps and
