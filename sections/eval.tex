...
\subfloat[Speedups for the filter of size $3 \times 3$ on RTX 2080 Ti.]{\includegraphics[width=\columnwidth,height=6cm]{./figure/2d_norm_f3_rtx2080.eps}
	\label{fig:2druntimef3c12080}}
\hspace{0em}
\subfloat[Speedups for the filter of size $5 \times 5$ on RTX 2080 Ti.]{\includegraphics[width=\columnwidth,height=6cm]{./figure/2d_norm_f5_rtx2080.eps}
...
\subfloat[Speedups on RTX 2080 Ti, left is for one channel and right is for three channels.]{\includegraphics[width=18cm,height=5.7cm]{./figure/3d_norm_c1_rtx2080.eps}
