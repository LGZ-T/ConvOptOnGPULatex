...
For small channel sizes ($I_N \leq 96$), the corresponding reduced channel sizes restrict  choices of the number of distributed channels, which may lead to suboptimal performance compared to original channel sizes.
...
\begin{table}[]
    ...
    \caption{Training time of MobileNetV2 on 2080Ti}
    \vspace{-3mm}
    \label{tab:traintime}
    \centering
    %\rowcolors{2}{}{Gray}
