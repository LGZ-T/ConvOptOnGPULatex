...
\caption{Speedups of cuDNN implicit and ours over the baseline implementation for depthwise convolution with filters of $3 \times 3$ and $5 \times 5$ on two platforms.} \label{fig:dwspeedup}
\end{figure*}
