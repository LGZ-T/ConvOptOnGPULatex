...
This study aims to optimize the memory performance involved when executing convolution operations on GPUs. To this end, we introduce two novel optimization techniques
