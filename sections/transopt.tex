...
sub-filters with some overlap columns. For example, \FIXME{and as illustrated in Fig. \ref{}}, a $7 \times 7$ filter can be divided into
...
\mypara{Working example.} Consider the standard convolution example shown in Fig. \ref{fig:rowreuse} as a working example for our row
