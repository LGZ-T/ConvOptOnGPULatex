...
\subsubsection{Generalization} While we describe our approach using a concrete working example with a pre-defined filter size, our
algorithms can be generalized to filters with an arbitary size. To apply our approach to a filter of size $n \times n$, we will first
