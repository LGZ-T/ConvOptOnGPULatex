...
duplicate rows.
%>>>>>>> 0927f39173553ae5355d494f9c447722252a41d1
...
%Figure \ref{fig:corealgo} depicts our column reuse algorithm, which consists of a number of steps, described as follows.
...
latency of around \FIXME{30????} cycles. If we can promote register allocation for $iTemp$, we can then further improve the performance of
convolution.
