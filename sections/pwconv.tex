...
with small inputs, we distribute channels across threads within a warp to \FIXME{xxx?}
...
\subsubsection{Determine candidates for $C_{num}$}
...
When searching for the optimal combination of \FIXME{xx and xx}, we focus on combinations that can meet the hardware resources constraints,
